  ...
  Widget build(BuildContext context) {
    ...
    return  BlocConsumer<CartBloc, CartState>(
            listener: (context, state) {
              if(state is CartError){
                Utils().showSnackBar(
                    ...
                    color: ColorsManager.redColor, fontSize: screenSize.width * 0.009,);
            ...
            builder: (context, state) {
              return state is GettingCart ? const LoadingColumnWidget(message: 'Fetching Cart')
                  : state is AddingCart ? const LoadingColumnWidget(message: 'Adding Cart')
                  : state is DeletingCart ? const LoadingColumnWidget(
                  message: 'Deleting Cart') : state is CartLoaded
              ? Expanded(
