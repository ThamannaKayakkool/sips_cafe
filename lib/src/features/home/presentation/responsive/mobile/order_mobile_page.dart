...
class OrderMobilePage extends StatelessWidget {
  const OrderMobilePage({super.key});
          ...
          return Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  TextWidget(
                      title: 'Payment', fontSize: screenSize.width * 0.04),
                  kSizedBox10,
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      TextWidget(
                          title: 'Subtotal', fontSize: screenSize.width * 0.03),
                      TextWidget(
                  ...
                  Row(
                    ...
                    children: [
                      TextWidget(
                          title: 'Total', fontSize: screenSize.width * 0.04),
                      Text(
