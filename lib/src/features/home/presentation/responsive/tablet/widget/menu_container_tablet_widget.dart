...
class MenuContainerTabletWidget extends StatelessWidget {
  final String selectedCategory;
  final List<String>category;
  final Function(String) onCategorySelected;
  const MenuContainerTabletWidget({super.key, required this.selectedCategory, required this.category, required this.onCategorySelected});
